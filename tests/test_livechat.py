...
LIVE_CHAT_URL = "https://dev.prowhats.com/en/contacts/live-chat"
...
class TestLiveChat:
    ...
    def navigate_to_live_chat(self, page: Page):
        page.goto(LIVE_CHAT_URL)
        page.wait_for_load_state(LOAD_STATE)

        expect(page).to_have_url(LIVE_CHAT_URL)
    ...
    def test_live_chat_page_loads(self, page: Page):
        """Verify Live chat page loads successfully."""
        self.login(page, ADMIN_EMAIL, ADMIN_PASSWORD)
        self.navigate_to_live_chat(page)
    ...
    def test_conversation_page_contains_chat_elements(self, page: Page):
        """Verify LiveChat page contains chat related UI elements."""
        self.login(page, ADMIN_EMAIL, ADMIN_PASSWORD)
        self.navigate_to_live_chat(page)
